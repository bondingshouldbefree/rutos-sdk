...
## Prerequisites
	...
	is accessible from "RUTM_R_GPL_00.07.16.4/scripts/dockerbuild".
...
## Building with Docker environment
	...
	2. Extract the  archive to an empty folder
		...
		$ mkdir RUTM_R_GPL_00.07.16.4
		$ tar -xzf ~/Downloads/RUTM_R_GPL_00.07.16.4.tar.gz -C RUTM_R_GPL_00.07.16.4

	3. Update feeds

		$ cd RUTM_R_GPL_00.07.16.4
	...
	5. Prepare packages for offline installation (optional)
		...
		After this you can find packages in "RUTM_R_GPL_00.07.16.4/bin/packages/<arch_name>/zipped_packages".
...
## Installation
	...
	After successful build you will get the firmware file in
		"RUTM_R_GPL_00.07.16.4/bin/targets/ramips/generic/tltFws".
...
## WebUI rebranding
	...
	All changes should be done in "RUTM_R_GPL_00.07.16.4/package/feeds/vuci/vuci-ui-core/bin/dist" folder.
...
## SSH Banner
	...
	2. Use figlet tool to generate needed text:
		...
		$ figlet YOUR_TEXT > "RUTM_R_GPL_00.07.16.4/package/base-files/files/etc/banner.logo"
...
## Default IP Change
	...
	1. Open the device family file in "RUTM_R_GPL_00.07.16.4/target/linux/ramips/image/devices/rutmxx_family.mk"
	...
	4. Regenerate the tmpinfo files by running:
		...
		$ rm -rf "RUTM_R_GPL_00.07.16.4/tmp"

## Default Password Change

	To change the default device password changes need to be made inside "RUTM_R_GPL_00.07.16.4/package/base-files/files/lib/preinit/84_set_password" file.
