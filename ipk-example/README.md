...
1. **Copy Package Files**
   ...
   ```sh
   cp -r "ipk-example" "RUTM_R_GPL_00.07.21.1/package/base/example_package"
   ```
...
3. **Build the Package**
   ...
   > `RUTM_R_GPL_00.07.21.1/bin/packages/ramips/base`
...
1. **Copy Package to Device**
   ...
   ```sh
   scp "RUTM_R_GPL_00.07.21.1/bin/packages/ramips/base/example_package_1.0-1_ramips.ipk" \
...
1. **Modify Package Configuration**
   ...
   Edit `RUTM_R_GPL_00.07.21.1/ipk_packages.json`:
...
4. **Compile Package Manager Packages**
   ...
   > `RUTM_R_GPL_00.07.21.1/bin/packages/<arch_name>/zipped_packages`
