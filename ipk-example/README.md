...
1. **Copy Package Files**
   ...
   ```sh
   cp -r "ipk-example" "RUTX_R_GPL_00.07.17/package/base/example_package"
   ```
...
3. **Build the Package**
   ...
   > `RUTX_R_GPL_00.07.17/bin/packages/ipq40xx/base`
...
1. **Copy Package to Device**
   ...
   ```sh
   scp "RUTX_R_GPL_00.07.17/bin/packages/ipq40xx/base/example_package_1.0-1_ipq40xx.ipk" \
...
1. **Modify Package Configuration**
   ...
   Edit `RUTX_R_GPL_00.07.17/ipk_packages.json`:
...
4. **Compile Package Manager Packages**
   ...
   > `RUTX_R_GPL_00.07.17/bin/packages/<arch_name>/zipped_packages`
